...
function updateView() {
    ...
    `;
    console.log(addPuzzlePiecesToButton());
...
function addPuzzlePieceToBoard(hasTop, hasRight, hasBottom, hasLeft,pieceId,pieceClass) {
   ...
   puzzlePieces += addPuzzlePiece('board', hasTop, hasRight, hasBottom, hasLeft, '', jigsawColor, verticalPosition, horizontalPosition,pieceId,pieceClass);
   updateView();
   console.log("PuzzlePieces: ",puzzlePieces);
//    console.log(addPuzzlePiece('board', hasTop, hasRight, hasBottom, hasLeft, '', jigsawColor, verticalPosition, horizontalPosition,pieceId,pieceClass));
...
function evaluateFirstRow(hasTop, hasRight, hasBottom, hasLeft,pieceId) {
   ...
   if(verticalPosition === horizontalMax && pieceId === 3)
    ...
    // updateView();
    // console.log(addPuzzlePieceToBoard(hasTop, hasRight, hasBottom, hasLeft,pieceId,'toBoard'));
